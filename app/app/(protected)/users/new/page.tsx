import CreateForm from "@/modules/user/components/forms/create/form";
...
export const metadata = generateSEOMetadata({
  title: "New User",
  description:
    "Add a new user to XITE Platform. Set up user details, roles, and permissions.",
});

export default async function NewUserPage() {
  const permission = await checkPermission("User", "write");
