...
// --- Icons ---
import { AlignCenterIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/align-right-icon";
