...
// --- Icons ---
import { BoldIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/bold-icon";
import { Code2Icon } from "@/modules/common/components/tiptap/components/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/underline-icon";
