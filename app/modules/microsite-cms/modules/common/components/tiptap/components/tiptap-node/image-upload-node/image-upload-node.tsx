...
import { CloseIcon } from "@/modules/common/components/tiptap/components/tiptap-icons/close-icon";
import "@/modules/common/components/tiptap/components/tiptap-node/image-upload-node/image-upload-node.scss";
import {
  focusNextNode,
  isValidPosition,
